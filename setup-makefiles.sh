...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/bin/load_oemlogo:system/bin/load_oemlogo \\
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/bin/load_oemlogo12:system/bin/load_oemlogo12 \\
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_DEVICE=hwu8510 PRODUCT_NAME=U8510 BUILD_ID=supertoast BUILD_DISPLAY_ID=CMX01 BUILD_FINGERPRINT=Huawei/U8510/hwu8510:2.3.3/HuaweiU8510/C169B831:user/ota-rel-keys,release-keys
